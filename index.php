...
<head>
	<title>Penjualan Kacamata</title>
		...
		<header>
			<div class="row">
				<div class="col-md-3 top-info text-left mt-lg-4">
					...
					<ul>
						<li>
							<i class="fas fa-phone"></i>Hubungi</li>
						<li class="number-phone mt-3">+62 813 7212 0950</li>
					</ul>
				</div>
							...
							<div class="login p-5 bg-dark mx-auto mw-100">
								<form action="login/proses_login.php" method="post">
									<div class="form-group">
										...
										<input name="username" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required="">
	...
	<footer class="py-lg-5 py-3">
		<div class="container-fluid px-lg-5 px-3">
			<div class="row footer-top-w3layouts">
				...
				<div class="col-lg-3 footer-grid-w3ls">
					...
					<div class="contact-info">
						...
						<div class="phone">
							<h4>Contact :</h4>
							<p>NO HP<a href="tel:+62 813 7212 0950">+62 813 7212 0950</a></p>
							<p>Email :
				...
				<div class="col-lg-3 footer-grid-w3ls">
					...
					<ul class="links">
						...
						<li>
							<a href="?page=kontak">Contact Us</a>
						</li>
					</ul>
				</div>
				<div class="col-lg-3 footer-grid-w3ls">
			...
			<div class="copyright-w3layouts mt-4">
				<p class="copy-right text-center ">&copy; 2020 AFTIADI STORE. All Rights Reserved | Design by
					<a href="http://w3layouts.com/"> ADRI AFTIADI </a>
				</p>
			</div>
		</div>
	</footer>
