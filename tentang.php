				...
				<div class="about-content py-lg-5 py-3">
					<div class="row">
						...
						<div class="col-lg-6 p-0">
							<img width="100%" src="images/<?php echo $data['foto'] ?>" alt="Goggles" class="img-fluid">
						</div>
						<div class="col-lg-6 about-info">
							<h3 class="tittle-w3layouts text-left mb-lg-5 mb-3">VISI MISI</h3>
							<p class="my-xl-4 my-lg-3 my-md-4 my-3">Visi
								<ul>
									<li>Menjadi toko fashion terbaik yang selalu terkemuka,unggul dan terdepan dalam pelayanan serta menjadi wadah pencetus usaha baru</li>
								</ul>	
							</p>
							<p class="my-xl-4 my-lg-3 my-md-4 my-3">Misi
								<ul>
									<li>Memberikan hasil fashion yang berkualitas dan inovatif</li>
									<li>Memberikan layanan yang baik dan solusi yang bernilai positif kepada konsumen</li>
								</ul>
							</p>
					...
					<div class="row mt-lg-5 mt-3">
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								<div class="team-img">
									<img class="img-fluid rounded" src="images/team1.jpeg" alt="">
								</div>
								<div class="team-info">
									<h4>Ari Saputra</h4>
